-- AlterTable
ALTER TABLE "Lead" ADD COLUMN "sourceFingerprint" TEXT;

-- AlterTable
ALTER TABLE "EnrichmentJob" ADD COLUMN "processedLeadIds" TEXT[] DEFAULT ARRAY[]::TEXT[];
...
-- CreateIndex
CREATE UNIQUE INDEX "Lead_organizationId_sourceFingerprint_key" ON "Lead"("organizationId", "sourceFingerprint");
